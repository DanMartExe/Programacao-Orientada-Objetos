...
public class App {
    ...
    public static void main(String[] args) {
        ...
        if (!pesquisarPalavra(palavra)) {
            System.out.println(String.format("A palavra '%s' nao esta presente no discurso", palavra.toUpperCase()));
            return;
        } else {
            System.out.println(String.format("A palavra '%s' esta presente no discurso", palavra.toUpperCase()));
        }
    }
